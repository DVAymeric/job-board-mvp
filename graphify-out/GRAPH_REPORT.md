...
## Corpus Check
- 428 files · ~240,607 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1709 nodes · 3910 edges · 154 communities (98 shown, 56 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 33 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4874c55f`
...
8. `logger` - 30 edges
9. `Button()` - 29 edges
10. `exactDedupKeyFromSource()` - 28 edges
...
### Community 1 - "harvest-query.ts"
Cohesion: 0.13
Nodes (17): CampaignConfig, CampaignConfigSchema, CampaignsFileSchema, CONTRACT_TYPE_TO_PRISMA_ENUM, mapYamlCampaignToCreateInput(), StoredCampaignConfigSchema, fixturesDir, HarvestLocation (+9 more)
...
Cohesion: 0.05
Nodes (48): ALTERNANCE_ONLY_TYPES, authHeaders(), buildSearchUrl(), CachedToken, checkFranceTravailHealth(), fetchFranceTravailOffers(), FRANCE_TRAVAIL_CONNECTOR_ID, FranceTravailClientOptions (+40 more)

### Community 4 - "auth-actions.ts"
Cohesion: 0.19
Nodes (9): AuthFormState, deleteAccount(), loginAction(), registerSchema, AccountView(), handleDeleteAccount(), push, initialState (+1 more)

### Community 5 - "logActionError"
Cohesion: 0.14
Nodes (39): addContact(), deleteContact(), updateContact(), clearHarvestedOffers(), ignoreHarvestedOffer(), updateJobContractType(), updateJobDetails(), updateJobDocuments() (+31 more)
...
Cohesion: 0.10
Nodes (14): exportJobsCsv(), asA(), createJobAsA(), CurrentUser, getCurrentUser(), mockAuth, UNAUTHENTICATED_ERROR, assertDatabaseUrlIsEncrypted() (+6 more)

### Community 8 - "review-queue-manager.tsx"
Cohesion: 0.12
Nodes (17): CONTRACT_TYPE_OPTIONS, SearchForm(), Input(), SelectContent(), SelectGroup(), SelectItem(), SelectLabel(), SelectScrollDownButton() (+9 more)

### Community 9 - "job-card.tsx"
Cohesion: 0.16
Nodes (10): getDisplayTitle(), JobCard(), handleDelete(), STATUS_DATE_LABEL, baseJob, StatusTimeline(), FOLLOW_UP_BADGE_CLASSNAME, JobContractType (+2 more)
...
Cohesion: 0.22
Nodes (12): Connector, ConnectorContext, francetravailConnector, labonnealternanceConnector, talentsoftConnector, ENV_KEYS, query, savedEnv (+4 more)

### Community 14 - "smartrecruiters/normalize.ts"
Cohesion: 0.19
Nodes (10): normalizeSmartRecruitersOffer(), fixturesDir, loadFixture(), loadRawOfferPayload(), SmartRecruitersPostingDetail, SmartRecruitersPostingDetailSchema, SmartRecruitersRawOffer, SmartRecruitersRawOfferSchema (+2 more)
...
Cohesion: 0.14
Nodes (20): CHECK_JOB_URL_RATE_LIMIT, checkJobUrl(), CREATE_JOB_RATE_LIMIT, createJob(), enrichJob(), KnownJobFields, afterCallbacks, mockAuthedAs() (+12 more)
...
### Community 18 - "cn"
Cohesion: 0.09
Nodes (26): logoutAction(), LINKS, MobileMenu(), Nav(), noopSubscribe(), session, ThemeToggle(), useMounted() (+18 more)

### Community 19 - "harvest.ts"
Cohesion: 0.08
Nodes (26): CONNECTORS_HEALTH_GLOBAL_RATE_LIMIT, CONNECTORS_HEALTH_RATE_LIMIT, getConnectorsHealth(), importHarvestedOffer(), __resetConnectorsHealthRateLimitsForTests(), { afterTasks }, mockAuthedAs(), mockUnauthenticated() (+18 more)
...
Cohesion: 0.12
Nodes (26): createCampaign(), deleteCampaign(), listCampaigns(), reorderCampaigns(), searchMetiers(), geocodedLille, mockAuthedAs(), mockUnauthenticated() (+18 more)

### Community 22 - "button.tsx"
Cohesion: 0.18
Nodes (10): AvatarJob, CompanyAvatar(), getInitial(), base, CampaignRow(), JobResultRow(), baseResult, Button() (+2 more)
...
Cohesion: 0.29
Nodes (7): companyNameFromDomain(), findAddressCategory(), normalizeTalentsoftOffer(), parseAddress(), stripReferencePrefix(), ADR-0004, departmentFromPostalCode()
...
Cohesion: 0.08
Nodes (27): ContactsSection(), handleAdd(), CampaignConfigJsonSchema, CampaignFormDialog(), buildPayload(), handleDelete(), EMPTY_LOCATION, LocationInput (+19 more)

### Community 27 - "analytics/page.tsx"
Cohesion: 0.13
Nodes (18): AnalyticsPage(), AnalyticsEmptyState(), buildInterviewSentence(), FunnelChart(), stages, ExportCsvButton(), handleExport(), Card() (+10 more)
...
Cohesion: 0.26
Nodes (11): checkSmartRecruitersHealth(), CONTRACT_TITLE_PATTERNS, fetchPostingDetail(), fetchPostingsList(), fetchSmartRecruitersOffers(), headers(), matchesContractTypes(), SMARTRECRUITERS_CONNECTOR_ID (+3 more)
...
Cohesion: 0.17
Nodes (17): checkTalentsoftHealth(), decodeXmlEntities(), detectTalentsoftPlatform(), extractAllTags(), extractTag(), fetchRssItems(), fetchTalentsoftOffers(), headers() (+9 more)

### Community 36 - "html-parser.ts"
Cohesion: 0.10
Nodes (28): BLOCK_PAGE_TITLES, isBlockPageTitle(), extractJobMetadataFromHtml(), extractMetaContent(), extractTitleTag(), extractEmploymentType(), extractHiringOrganizationName(), extractJobLocation() (+20 more)
...
### Community 40 - "discovery.ts"
Cohesion: 0.20
Nodes (14): approveDiscoveredTarget(), PLATFORM_TO_TARGETS_KEY, rejectDiscoveredTarget(), mockAuthedAs(), DiscoveredTargetsManager(), handleApprove(), handleReject(), removeTarget() (+6 more)
...
### Community 44 - "digitalrecruiters/client.ts"
Cohesion: 0.29
Nodes (8): checkDigitalRecruitersHealth(), DIGITALRECRUITERS_CONNECTOR_ID, DigitalRecruitersClientOptions, fetchDigitalRecruitersOffers(), fetchJobAdsPage(), headers(), query, digitalRecruitersConnector

### Community 45 - "NormalizedOffer"
Cohesion: 0.39
Nodes (7): FUZZY_MATCH_THRESHOLD, isDuplicate(), isExactDuplicate(), isFuzzyDuplicate(), mergeOffers(), unionSourceRefs(), NormalizedOffer

### Community 46 - "constants.ts"
Cohesion: 0.15
Nodes (11): BOARD_JOBS_SAFETY_LIMIT, FOLLOW_UP_DAYS, isJobContractType(), JOB_CONTRACT_TYPE, JOB_CONTRACT_TYPE_LABELS, JOB_CONTRACT_TYPE_ORDER, needsFollowUp(), SALARY_TYPE (+3 more)
...
### Community 52 - "register-form.tsx"
Cohesion: 0.38
Nodes (4): registerAction(), registerUser(), initialState, RegisterForm()

### Community 53 - "url-check-bar.tsx"
Cohesion: 0.33
...
Cohesion: 0.10
Nodes (22): criteriaFromSearchParams(), firstParam(), RecherchePage(), JobResult, EMPTY_CRITERIA, OfferSearch(), SearchableOffer, SearchCriteria (+14 more)
...
Cohesion: 0.15
Nodes (10): Board(), jobs, Column(), EnrichmentPollWatcher(), matchesJobQuery(), matchesSelectedTags(), job(), jobWithTags() (+2 more)
...
Cohesion: 0.14
Nodes (14): ContractType, Lifecycle, LifecycleSchema, NormalizedOfferSchema, RemotePolicy, RemotePolicySchema, SourceRef, SourceRefSchema (+6 more)
...
Cohesion: 0.15
Nodes (14): LocationConfig, LocationConfigSchema, buildHarvestQueryForLocation(), CampaignConfigJsonSchema, CONTRACT_TYPE_FROM_PRISMA, createdCampaignIds, makeOffer(), normalize() (+6 more)

### Community 118 - "welcometothejungle/normalize.ts"
Cohesion: 0.24
Nodes (8): canonicalizeUrl(), TRACKING_PARAM_PREFIXES, TRACKING_PARAMS_EXACT, buildCanonicalUrl(), mapRemotePolicy(), normalizeWttjOffer(), fixturesDir, inferContractTypeFromText()

### Community 137 - "ReviewQueueManager"
Cohesion: 0.12
Nodes (18): maxDuration, StatTile(), StatTileProps, formatDate(), ReviewQueueManager(), handleClearAll(), handleIgnore(), handleImport() (+10 more)
...
### Community 142 - "exactDedupKeyFromSource"
Cohesion: 0.48
Nodes (6): exactDedupKeyFromSource(), harvestedOfferToNormalizedOffer(), normalizedOfferToHarvestedOfferData(), makeOffer(), toFakeRow(), upsertOffer()
...
Cohesion: 0.24
Nodes (9): mapContractType(), mapOriginSource(), normalizeLbaOffer(), parseFrenchAddress(), SELF_PARTNER_LABELS, fixturesDir, exactDedupKeyFromUrl(), sha1() (+1 more)

### Community 146 - "home-content.tsx"
Cohesion: 0.47
Nodes (3): HeroSection(), HeroSectionProps, ViewState

### Community 147 - "timedHealthCheck"
Cohesion: 0.23
Nodes (6): CONNECTOR_LABELS, ConnectorHealthList(), formatRelativeDate(), ConnectorHealth, healthCheckWithTimeout(), timedHealthCheck()
...
### Community 159 - "workday/normalize.ts"
Cohesion: 0.27
Nodes (7): normalizeWorkdayOffer(), fixturesDir, loadFixture(), loadRawOfferPayload(), target, ENTITY_REPLACEMENTS, stripHtml()
...
- **Why does `logger` connect `logger.ts` to `geocoding.ts`, `talentsoft/client.ts`, `prisma.ts`, `discover-targets.ts`, `digitalrecruiters/client.ts`, `_shared.ts`, `fetch-strategy.ts`, `harvest.ts`, `workday/client.ts`, `rate-limited-fetch.ts`, `labonnealternance/client.ts`, `orchestrator.ts`, `welcometothejungle/client.ts`, `campaign-validation.ts`, `smartrecruiters/client.ts`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `bento-card.tsx`, `application-heatmap.tsx`, `review-queue-manager.tsx`, `ReviewQueueManager`, `job-card.tsx`, `alert-dialog.tsx`, `review/page.tsx`, `url-check-bar.tsx`, `button.tsx`, `badge.tsx`, `job-dialog.tsx`, `analytics/page.tsx`, `STATUS`, `board.tsx`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `Button()` connect `button.tsx` to `bento-card.tsx`, `auth-actions.ts`, `review-queue-manager.tsx`, `job-card.tsx`, `discovery.ts`, `alert-dialog.tsx`, `cn`, `timedHealthCheck`, `register-form.tsx`, `url-check-bar.tsx`, `job-dialog.tsx`, `analytics/page.tsx`, `campaign-validation.ts`, `board.tsx`?**
...
- **Should `harvest-query.ts` be split into smaller, more focused modules?**
