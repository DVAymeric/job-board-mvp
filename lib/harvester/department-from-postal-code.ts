// JOB-27 (job-harvester) : les DOM (Guadeloupe 971, Martinique 972, Guyane 973, Réunion 974,
// Mayotte 976) et les COM dont le code postal suit la même convention à 3 chiffres (975 Saint-
// Pierre-et-Miquelon, 977/978 Saint-Barthélemy/Saint-Martin, 984/986/987/988 pour les TOM du
// Pacifique) ont un département à 3 chiffres, pas 2 — une troncature aveugle à 2 caractères
// produit un code department faux ("97" au lieu de "971", etc.).
//
