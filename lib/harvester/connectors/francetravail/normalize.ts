...
// JOB-27 (job-harvester) : la Corse utilise littéralement "2A"/"2B" comme code département dans
// ce libellé (contrairement aux DOM, où le code postal est à 3 chiffres numériques) — sans ce
// cas, un libellé "2A - Ajaccio" ne matchait aucun des deux groupes et retombait sur le libellé
// complet comme ville, sans département.
