...
import { fetchFranceTravailOffers, checkFranceTravailHealth, FRANCE_TRAVAIL_CONNECTOR_ID } from "@/lib/harvester/connectors/francetravail/client";
import { normalizeFranceTravailOffer } from "@/lib/harvester/connectors/francetravail/normalize";
...
export const francetravailConnector: Connector = {
  ...
  // donné — plus de restriction ici, le tri se fait en aval via query-filter.ts (JOB-78-bis).
  supports(): boolean {
    return true;
  },
