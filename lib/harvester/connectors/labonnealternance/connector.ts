...
import { fetchLbaOffers, checkLbaHealth, LBA_CONNECTOR_ID } from "@/lib/harvester/connectors/labonnealternance/client";
import { normalizeLbaOffer } from "@/lib/harvester/connectors/labonnealternance/normalize";
  ...
  async healthCheck() {
    ...
    if (!apiKey) {
      return {
        ...
        message: "LBA_API_KEY is not set",
      };
    }
