...
// JOB-31 (job-harvester) : vérifié en direct sur `joinus.decathlon.fr` — whitelist stricte des
// champs utilisés par normalize.ts ; aucun champ de contact recruteur n'est exposé par cet
// endpoint.
