...
describe("normalizeWorkdayOffer", () => {
  it("maps fields, strips HTML from the description, and uses the externalUrl as applyUrl", () => {
    ...
    // JOB-33 (job-harvester) : inferContractTypeFromText reconnaît "alternant"/"alternance"
    // comme mappant à apprentissage par défaut (le titre/la description les contiennent).
