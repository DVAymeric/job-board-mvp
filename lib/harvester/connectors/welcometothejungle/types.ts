...
// JOB-31 (job-harvester) : vérifié en direct (requête réelle contre `wk_cms_jobs_production`) —
// whitelist stricte des champs consommés par normalize.ts. Aucun champ de contact recruteur
// n'existe dans cet index (il ne renvoie que des données publiques d'offre/entreprise).
